...
override PKGDIR = xconfig_appBLEprintf
...
package/%.xdc.inc package/%_xconfig_appBLEprintf.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_appBLEprintf" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: appBLEprintf.pem3

-include package/cfg/appBLEprintf_pem3.mak
-include package/cfg/appBLEprintf_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/appBLEprintf_pem3.dep
endif
appBLEprintf.pem3: package/cfg/appBLEprintf_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
appBLEprintf.pem3 package/cfg/appBLEprintf_pem3.c: .libraries,em3
endif

package/cfg/appBLEprintf_pem3.c package/cfg/appBLEprintf_pem3.h package/cfg/appBLEprintf_pem3.xdl: override _PROG_NAME := appBLEprintf.xem3
package/cfg/appBLEprintf_pem3.c: package/cfg/appBLEprintf_pem3.cfg
package/cfg/appBLEprintf_pem3.xdc.inc: package/cfg/appBLEprintf_pem3.xdl
package/cfg/appBLEprintf_pem3.xdl package/cfg/appBLEprintf_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/appBLEprintf_pem3.cfg
	-$(RM) package/cfg/appBLEprintf_pem3.dep
	-$(RM) package/cfg/appBLEprintf_pem3.c
	-$(RM) package/cfg/appBLEprintf_pem3.xdc.inc

clean,em3::
	-$(RM) appBLEprintf.pem3
.executables,em3 .executables: appBLEprintf.xem3

appBLEprintf.xem3: |appBLEprintf.pem3

-include package/cfg/appBLEprintf.xem3.mak
appBLEprintf.xem3: package/cfg/appBLEprintf_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/appBLEprintf_pem3.oem3   package/cfg/appBLEprintf_pem3.xdl --silicon_version=7M3 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
appBLEprintf.xem3: export C_DIR=
appBLEprintf.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
appBLEprintf.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

appBLEprintf.test test,em3 test: appBLEprintf.xem3.test

appBLEprintf.xem3.test:: appBLEprintf.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 appBLEprintf.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.appBLEprintf.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,appBLEprintf.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) appBLEprintf.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
appBLEprintf_pem3.oem3,copy : package/cfg/appBLEprintf_pem3.oem3
appBLEprintf_pem3.sem3,copy : package/cfg/appBLEprintf_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_appBLEprintf
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_appBLEprintf.tar.dep
endif
package/rel/xconfig_appBLEprintf/xconfig_appBLEprintf/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_appBLEprintf/xconfig_appBLEprintf/package/package.rel.xml: package/build.cfg
package/rel/xconfig_appBLEprintf/xconfig_appBLEprintf/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_appBLEprintf/xconfig_appBLEprintf/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_appBLEprintf.tar: package/rel/xconfig_appBLEprintf.xdc.inc package/rel/xconfig_appBLEprintf/xconfig_appBLEprintf/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_appBLEprintf.xdc.inc,package/rel/xconfig_appBLEprintf.tar.dep)


release release,xconfig_appBLEprintf: all xconfig_appBLEprintf.tar
clean:: .clean
	-$(RM) xconfig_appBLEprintf.tar
	-$(RM) package/rel/xconfig_appBLEprintf.xdc.inc
	-$(RM) package/rel/xconfig_appBLEprintf.tar.dep
