# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.c"
...
# 18 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.c"
...
# 19 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.c"
...
#pragma diag_pop
# 21 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.c"

# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/SysMin.xdc.h"
...
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.h"
...
# 56 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.h"
...
# 59 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.h"
...
typedef void (*xdc_runtime_SysMin_OutputFxn)(xdc_Char*, xdc_UInt);
...
extern  const CT__xdc_runtime_SysMin_Module__diagsEnabled xdc_runtime_SysMin_Module__diagsEnabled__C;

 
typedef xdc_Bits32 CT__xdc_runtime_SysMin_Module__diagsIncluded;
extern  const CT__xdc_runtime_SysMin_Module__diagsIncluded xdc_runtime_SysMin_Module__diagsIncluded__C;

 
typedef xdc_Bits16 *CT__xdc_runtime_SysMin_Module__diagsMask;
extern  const CT__xdc_runtime_SysMin_Module__diagsMask xdc_runtime_SysMin_Module__diagsMask__C;

 
typedef xdc_Ptr CT__xdc_runtime_SysMin_Module__gateObj;
extern  const CT__xdc_runtime_SysMin_Module__gateObj xdc_runtime_SysMin_Module__gateObj__C;

 
typedef xdc_Ptr CT__xdc_runtime_SysMin_Module__gatePrms;
extern  const CT__xdc_runtime_SysMin_Module__gatePrms xdc_runtime_SysMin_Module__gatePrms__C;

 
typedef xdc_runtime_Types_ModuleId CT__xdc_runtime_SysMin_Module__id;
extern  const CT__xdc_runtime_SysMin_Module__id xdc_runtime_SysMin_Module__id__C;

 
typedef xdc_Bool CT__xdc_runtime_SysMin_Module__loggerDefined;
extern  const CT__xdc_runtime_SysMin_Module__loggerDefined xdc_runtime_SysMin_Module__loggerDefined__C;

 
typedef xdc_Ptr CT__xdc_runtime_SysMin_Module__loggerObj;
extern  const CT__xdc_runtime_SysMin_Module__loggerObj xdc_runtime_SysMin_Module__loggerObj__C;

 
typedef xdc_runtime_Types_LoggerFxn0 CT__xdc_runtime_SysMin_Module__loggerFxn0;
extern  const CT__xdc_runtime_SysMin_Module__loggerFxn0 xdc_runtime_SysMin_Module__loggerFxn0__C;
...
extern  const CT__xdc_runtime_SysMin_Module__loggerFxn2 xdc_runtime_SysMin_Module__loggerFxn2__C;

 
typedef xdc_runtime_Types_LoggerFxn4 CT__xdc_runtime_SysMin_Module__loggerFxn4;
extern  const CT__xdc_runtime_SysMin_Module__loggerFxn4 xdc_runtime_SysMin_Module__loggerFxn4__C;

 
typedef xdc_runtime_Types_LoggerFxn8 CT__xdc_runtime_SysMin_Module__loggerFxn8;
extern  const CT__xdc_runtime_SysMin_Module__loggerFxn8 xdc_runtime_SysMin_Module__loggerFxn8__C;

 
typedef xdc_Bool (*CT__xdc_runtime_SysMin_Module__startupDoneFxn)(void);
extern  const CT__xdc_runtime_SysMin_Module__startupDoneFxn xdc_runtime_SysMin_Module__startupDoneFxn__C;
...
extern  const CT__xdc_runtime_SysMin_Object__heap xdc_runtime_SysMin_Object__heap__C;

 
typedef xdc_SizeT CT__xdc_runtime_SysMin_Object__sizeof;
extern  const CT__xdc_runtime_SysMin_Object__sizeof xdc_runtime_SysMin_Object__sizeof__C;

 
typedef xdc_Ptr CT__xdc_runtime_SysMin_Object__table;
extern  const CT__xdc_runtime_SysMin_Object__table xdc_runtime_SysMin_Object__table__C;
...
extern  const CT__xdc_runtime_SysMin_bufSize xdc_runtime_SysMin_bufSize__C;
...
extern  const CT__xdc_runtime_SysMin_flushAtExit xdc_runtime_SysMin_flushAtExit__C;


 

typedef xdc_runtime_SysMin_OutputFxn CT__xdc_runtime_SysMin_outputFxn;
extern  const CT__xdc_runtime_SysMin_outputFxn xdc_runtime_SysMin_outputFxn__C;

 

typedef xdc_runtime_SysMin_OutputFxn CT__xdc_runtime_SysMin_outputFunc;
extern  const CT__xdc_runtime_SysMin_outputFunc xdc_runtime_SysMin_outputFunc__C;
...
extern const xdc_runtime_SysMin_Fxns__ xdc_runtime_SysMin_Module__FXNS__C;
...
extern xdc_Int xdc_runtime_SysMin_Module_startup__E( xdc_Int state );

extern xdc_Int xdc_runtime_SysMin_Module_startup__F( xdc_Int state );

 

extern xdc_Bool xdc_runtime_SysMin_Module__startupDone__S( void );

 


extern void xdc_runtime_SysMin_abort__E( xdc_CString str );

 


extern void xdc_runtime_SysMin_exit__E( xdc_Int stat );

 


extern void xdc_runtime_SysMin_flush__E( void );

 


extern void xdc_runtime_SysMin_putch__E( xdc_Char ch );

 


extern xdc_Bool xdc_runtime_SysMin_ready__E( void );

 


extern void xdc_runtime_SysMin_output__I( xdc_Char *buf, xdc_UInt size );
...
{
    return xdc_runtime_SysMin_Module__diagsMask__C != 0;
}

 
static inline xdc_Bits16 xdc_runtime_SysMin_Module_getMask( void ) 
{
    return xdc_runtime_SysMin_Module__diagsMask__C != 0 ? *xdc_runtime_SysMin_Module__diagsMask__C : 0;
}

 
static inline void xdc_runtime_SysMin_Module_setMask( xdc_Bits16 mask ) 
{
    if (xdc_runtime_SysMin_Module__diagsMask__C != 0) *xdc_runtime_SysMin_Module__diagsMask__C = mask;
}
...
# 369 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/SysMin.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/SysMin.xdc.h"
...
# 101 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/SysMin.xdc.h"


# 23 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/SysMin.c"



 
Int xdc_runtime_SysMin_Module_startup__E(Int phase)
{
    if ((xdc_runtime_SysMin_bufSize__C) != 0) {
        memset(((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outbuf, 0, (xdc_runtime_SysMin_bufSize__C));
    }
    return ((-1));
}
...
void xdc_runtime_SysMin_abort__E(CString str)
{
    Char ch;    
    ...
    if ((xdc_runtime_SysMin_bufSize__C) != 0) {
        if (str != 0) {
            while ((ch = *str++) != '\0') {
                xdc_runtime_SysMin_putch__E(ch);
            }
        }

         
        if ((xdc_runtime_SysMin_flushAtExit__C)) {
...
void xdc_runtime_SysMin_exit__E(Int stat)
{
    if (((xdc_runtime_SysMin_flushAtExit__C)) && ((xdc_runtime_SysMin_bufSize__C) != 0)) {
        xdc_runtime_SysMin_flush__E();
    }
}
...
void xdc_runtime_SysMin_putch__E(Char ch)
{
    IArg key;
    ...
    if ((xdc_runtime_SysMin_bufSize__C) != 0) {
        ...
        ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outbuf[((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outidx++] = ch;
        if (((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outidx == (xdc_runtime_SysMin_bufSize__C)) {
            ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outidx = 0;
            ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->wrapped = 1;
        }
...
Bool xdc_runtime_SysMin_ready__E()
{
    return ((xdc_runtime_SysMin_bufSize__C) != 0);
}
...
void xdc_runtime_SysMin_flush__E()
{
    IArg key;
    ...
    if (((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->wrapped == 1) {
        (xdc_runtime_SysMin_outputFunc__C)(((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outbuf + ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outidx,
                          (xdc_runtime_SysMin_bufSize__C) - ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outidx);
    }
    
    (xdc_runtime_SysMin_outputFunc__C)(((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outbuf, ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outidx);
    ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->outidx = 0;
    ((xdc_runtime_SysMin_Module_State *)((&(xdc_runtime_SysMin_Module__state__V))))->wrapped = 0;
