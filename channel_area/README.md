...
an option.
A **Properties** button on the right opens another panel with tabs for display and channel information. Check *Pin* to keep this menu visible.
