...
The sidebar includes a **Display Settings** section to toggle **Show Vectors**, **Show Bounding Box** and **Show Measurements**. The **Edit Tools** menu offers **Enable Measurements** alongside **Add Points**; only one of these edit tools can be active at a time.
