...
Selecting **Egg Shape Channel** combines two circles. Enter the diameters for the bottom and top circles and the distance between their centres. The sides are straight lines joining the far left and right points of the two circles, producing an egg-like outline.
