...
A responsive Dock Panel appears beside the canvas in landscape and below it in portrait mode. Use the **Copy Image** button on the Edit Tools tab to copy the current canvas to the clipboard. An **Upload Image** button lets you place a reference picture onto the canvas for tracing. When an image is loaded, the **Move Image** checkbox allows you to drag it around the canvas, and an **Image Scale** field lets you resize it for easier tracing.
